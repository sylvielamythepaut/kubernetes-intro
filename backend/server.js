...
app.get('/api/me', (request, response) => {
	response.send('{"name": "Sylvie Lamy-Thepaut", "location": "Reading"}');
...
app.get('/api/education', (request, response) => {
	response.send('[{"yearFrom": "2005", "yearTo": "2007", "place": "Ankara", "comment": "Studying"}, {"yearFrom": "2005", "yearTo": "2007", "place": "Paris 1", "comment": "Studying"}, {"yearFrom": "2001", "yearTo": "2004", "place": "Toulouse academy", "comment": "Made coffee"}]');
